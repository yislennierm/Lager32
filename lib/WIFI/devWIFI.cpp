...
#include "WebContent.h"          // <-- MUST be included for INDEX_HTML/CSS/JS blobs

#include "config.h"

// These declare getOptions()/getHardware()/saveOptions.
// If your tree doesn't have options_json.h, keep the forward-decls below instead.
#if __has_include("options_json.h")
  #include "options_json.h"
#else
  extern const char* getOptions();
  extern const char* getHardware();
  void saveOptions();
#endif
