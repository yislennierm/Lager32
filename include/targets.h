...
#ifndef BB_WEBUI_ONLY
  #define BB_WEBUI_ONLY 0
#endif
#if BB_WEBUI_ONLY
  #ifndef PLATFORM_ESP32
    #define PLATFORM_ESP32
  #endif
  #ifndef PLATFORM_ESP32_S2
    #define PLATFORM_ESP32_S2
  #endif
  #ifndef UNDEF_PIN
    #define UNDEF_PIN (-1)
  #endif
...
#endif
#else
#if !defined(BB_WEBUI_ONLY) && \
    !defined(RADIO_SX127X) && !defined(RADIO_LR1121) && !defined(RADIO_SX128X)
